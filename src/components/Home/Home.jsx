...
const Home = () => {
  ...
  return (
    <div className='justify-center items-center flex-col w-full'>
      <div className='flex mb-4 mt-10 gap-2 flex-col-reverse  ss:flex-row items-center ss:justify-between font-poppins'>
        <input value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} type='text' placeholder='Search...' className='py-2 px-4 rounded-md bg-whitePowder text-[20px] text-blackRich' />
        { user ? 
